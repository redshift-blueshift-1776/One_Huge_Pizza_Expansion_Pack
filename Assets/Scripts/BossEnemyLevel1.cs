...
public class BossEnemyLevel1 : MonoBehaviour
{
    ...
    void Attack1()
    {
        ...
        if ((Time.frameCount % 120 == 0) || (Time.frameCount % 120 == 75) || (Time.frameCount % 120 == 90)) {
        ...
        // if ((audioController.time % 2.0 == 0) || (audioController.time % 2.0 == 1.25) || (audioController.time % 2.0 == 1.5)) {
        //     Vector3 vec = new Vector3(.05f, .05f, .05f);
        //     shootBullet(vec, new Vector3(0,-1,0), 8f);
        //     shootBullet(vec, new Vector3(0,1,0), 8f);
        //     shootBullet(vec, new Vector3(1,0,0), 8f);
        //     shootBullet(vec, new Vector3(0,-1,0), 8f);
        // }
        // if (Time.frameCount % 120 == 30 || Time.frameCount % 60 == 90) {
        //     Vector3 vec = new Vector3(.03f, .03f, .03f);
        //     float d = Vector3.Distance(transform.position, player.transform.position);
        //     shootBullet(vec, new Vector3((player.transform.position.x - transform.position.x) / d,
        //     (player.transform.position.y - transform.position.y) / d,0), 16f);
        // }
        // if (Time.frameCount % 120 == 60) {
        //     Vector3 vec = new Vector3(.05f, .05f, .05f);
        //     float d = Vector3.Distance(transform.position, player.transform.position);
