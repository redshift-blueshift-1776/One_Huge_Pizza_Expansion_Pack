    ...
    void Attack1()
    {
        ...
        if (frameDif >= 480) {
            if (frameDif % 120 == 0) {
                ...
                shootBullet(vec, new Vector3(-0.2f,0,0), 3f);
                shootBullet(vec, new Vector3(-0.4f,0,0), 3f);
                shootBullet(vec, new Vector3(-0.6f,0,0), 3f);
                shootBullet(vec, new Vector3(-0.8f,0,0), 3f);
                shootBullet(vec, new Vector3(-1,0,0), 3f);
                shootBullet(vec, new Vector3(-1,0.4f,0), 3f);
                shootBullet(vec, new Vector3(-1,0.6f,0), 3f);
                shootBullet(vec, new Vector3(-1,0.8f,0), 3f);
                shootBullet(vec, new Vector3(-1,1,0), 3f);
                shootBullet(vec, new Vector3(-0.2f,1,0), 3f);
                shootBullet(vec, new Vector3(-0.4f,1,0), 3f);
                shootBullet(vec, new Vector3(-0.6f,1,0), 3f);
                shootBullet(vec, new Vector3(-0.8f,1,0), 3f);
                shootBullet(vec, new Vector3(0,1,0), 3f);
                shootBullet(vec, new Vector3(0,0.2f,0), 3f);
                shootBullet(vec, new Vector3(0,0.4f,0), 3f);
                shootBullet(vec, new Vector3(0,0.6f,0), 3f);
                shootBullet(vec, new Vector3(0,0.8f,0), 3f);
                shootBullet(vec, new Vector3(0.2f,1,0), 3f);
                shootBullet(vec, new Vector3(0.4f,1,0), 3f);
                shootBullet(vec, new Vector3(0.6f,1,0), 3f);
                shootBullet(vec, new Vector3(0.8f,1,0), 3f);
                shootBullet(vec, new Vector3(1,1,0), 3f);
                shootBullet(vec, new Vector3(-0.6f,-0.2f,0), 3f);
                shootBullet(vec, new Vector3(-0.6f,-0.4f,0), 3f);
